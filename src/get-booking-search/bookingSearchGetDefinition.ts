...
export const bookingSearchGetDefinition = {
  description: "Returns search results from Booking.com",
  folder: "get-booking-search",
  method: "GET",
  operationId: "getBooking-Search",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/booking-search?query=https%3A%2F%2Fwww.booking.com%2Fsearchresults.html%3Fss%3DRome%252C%2BLazio%252C%2BItaly&limit=3&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/booking-search?query=https%3A%2F%2Fwww.booking.com%2Fsearchresults.html%3Fss%3DRome%252C%2BLazio%252C%2BItaly&limit=3" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
