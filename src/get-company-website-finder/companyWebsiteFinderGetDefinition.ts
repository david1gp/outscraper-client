...
export const companyWebsiteFinderGetDefinition = {
  description: "Finds company websites based on business names.",
  folder: "get-company-website-finder",
  method: "GET",
  operationId: "getCompany-Website-Finder",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/company-website-finder?query=Apple%20Inc&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/company-website-finder?query=Apple%20Inc" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "Python",
      source:
