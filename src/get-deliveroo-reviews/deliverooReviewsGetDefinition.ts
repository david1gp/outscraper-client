...
export const deliverooReviewsGetDefinition = {
  description: "Returns reviews from Deliveroo.",
  folder: "get-deliveroo-reviews",
  method: "GET",
  operationId: "getDeliveroo-Reviews",
  parameters: [
    {
      description:
    ...
    },
    {
      ...
      schema: {
        ...
        enum: ["highest_rated", "lowest_rated", "newest", "oldest"],
        type: "string",
      },
    },
    {
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/deliveroo-reviews?query=https://deliveroo.fr/fr/menu/Paris/batignolles/burger-king-paris-porte-de-clichy&limit=3&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/deliveroo-reviews?query=https://deliveroo.fr/fr/menu/Paris/batignolles/burger-king-paris-porte-de-clichy&limit=3" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
