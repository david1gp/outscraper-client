...
export const googleSearchImagesGetDefinition = {
  description: "Returns images search results from Google based on a given search query (or many queries).",
  folder: "get-google-search-images",
  method: "GET",
  operationId: "getGoogle-Search-Images",
  parameters: [
    {
      description:
            ...
            data: [
              [
                ...
                },
                {
                  ...
                  source: "apple.com",
                  source_link:
                    "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.apple.com%2Fshop%2Fbuy-iphone%2Fiphone-12&psig=AOvVaw2uqlbYdMQn4a6OHbkjPPFf&ust=1652790673122000&source=images&cd=vfe&ved=2ahUKEwiLi_mYg-T3AhUeCBAIHWJTCoIQr4kDegUIARDaAQ",
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/google-search-images?query=iphone&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/google-search-images?query=iphone" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
