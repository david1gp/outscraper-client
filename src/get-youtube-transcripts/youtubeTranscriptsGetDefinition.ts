...
export const youtubeTranscriptsGetDefinition = {
  description: "Returns transcripts from YouTube videos.",
  folder: "get-youtube-transcripts",
  method: "GET",
  operationId: "getYoutube-Transcripts",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/youtube-transcripts?query=ph5pHgklaZ0&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/youtube-transcripts?query=ph5pHgklaZ0" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
