...
export const phonesEnricherGetDefinition = {
  description: "Returns phone carrier data (name/type), validates phones and ensures message deliverability.",
  folder: "get-phones-enricher",
  method: "GET",
  operationId: "getPhones-Enricher",
  parameters: [
    {
      description:
      ...
      content: [
        {
          example: {
            data: [
              {
                carrier_name: "AERIAL COMMUNICATIONS",
                carrier_type: "mobile",
                query: "12812368208",
              },
            ],
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/phones-enricher?query=12812368208" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "Python",
      source:
