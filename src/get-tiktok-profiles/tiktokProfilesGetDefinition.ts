...
export const tiktokProfilesGetDefinition = {
  description: "Returns information from the list of TikTok profiles.",
  folder: "get-tiktok-profiles",
  method: "GET",
  operationId: "getTiktok-Profiles",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/tiktok-profiles?query=outscraper&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/tiktok-profiles?query=outscraper" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
