...
export const getappReviewsGetDefinition = {
  description: "Returns reviews from GetApp apps.",
  folder: "get-getapp-reviews",
  method: "GET",
  operationId: "getGetapp-Reviews",
  parameters: [
    {
      description:
    ...
    },
    {
      ...
      schema: {
        default: "recommended",
        enum: ["recommended", "most_recent", "least_recent", "highest_rated", "lowest_rated"],
        type: "string",
      },
    },
    {
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/getapp-reviews?query=https%3A%2F%2Fwww.getapp.com%2Fcustomer-management-software%2Fa%2Fsalesforce%2Freviews%2F&limit=3&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/getapp-reviews?query=https%3A%2F%2Fwww.getapp.com%2Fcustomer-management-software%2Fa%2Fsalesforce%2Freviews%2F&limit=3" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
