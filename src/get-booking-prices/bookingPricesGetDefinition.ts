...
export const bookingPricesGetDefinition = {
  description: "Returns prices from a list of hotels.",
  folder: "get-booking-prices",
  method: "GET",
  operationId: "getBooking-Prices",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/booking-prices?query=https://www.booking.com/hotel/pl/aparthotel.fr.html&limit=3&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/booking-prices?query=https://www.booking.com/hotel/pl/aparthotel.fr.html&limit=3" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
