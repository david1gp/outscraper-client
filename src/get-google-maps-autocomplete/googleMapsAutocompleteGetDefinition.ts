...
export const googleMapsAutocompleteGetDefinition = {
  description: "Get automatic search suggestions for your queries on Google Maps.",
  folder: "get-google-maps-autocomplete",
  method: "GET",
  operationId: "getGoogle-Maps-Autocomplete",
  parameters: [
    {
      description:
        "Coordinates from Google Maps URL (e.g., '@23.4933124,53.9623381,11.42z'). Optional parameter to bias results towards a specific location.",
      in: "query",
      location: "query",
      name: "coordinates",
      required: false,
