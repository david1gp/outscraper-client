...
export const youtubeVideosGetDefinition = {
  description: "Returns videos from YouTube channels.",
  folder: "get-youtube-videos",
  method: "GET",
  operationId: "getYoutube-Videos",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/youtube-videos?query=@Google&limit=1&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/youtube-videos?query=@Google&limit=1" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
