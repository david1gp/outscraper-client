...
export const whitepagesAddressesGetDefinition = {
  description: "Returns insights about addresses and their residents.",
  folder: "get-whitepages-addresses",
  method: "GET",
  operationId: "getWhitepages-Addresses",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/whitepages-addresses?query=321%20California%20Ave%2C%20Palo%20Alto%2C%20CA%2094306" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
