...
export const zillowSearchGetDefinition = {
  description: "Returns listings from Zillow.",
  folder: "get-zillow-search",
  method: "GET",
  operationId: "getZillow-Search",
  parameters: [
    {
      description:
    ...
    {
      description: "The parameter specifies one of the main filters.",
      in: "query",
      location: "query",
      name: "mainFilter",
      required: false,
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/zillow-search?query=Jacksonville%2C%20FL%26limit&limit=3&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/zillow-search?query=Jacksonville%2C%20FL%26limit&limit=3" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
