...
export const producthuntReviewsGetDefinition = {
  description: "Returns reviews from Product Hunt.",
  folder: "get-producthunt-reviews",
  method: "GET",
  operationId: "getProducthunt-Reviews",
  parameters: [
    {
      description:
    ...
    },
    {
      ...
      schema: {
        default: "BEST",
        enum: ["BEST", "LATEST", "FAVORABLE", "CRITICAL"],
        type: "string",
      },
    },
    {
  ...
  responses: [
    {
      content: [
        {
          example: {
            $ref: "#/components/schemas/results/producthunt_reviews",
          },
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/producthunt-reviews?query=outscraper&limit=3&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/producthunt-reviews?query=outscraper&limit=3" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
