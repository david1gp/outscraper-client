...
export const universalScraperGetDefinition = {
  description: "Extracts the data you need from any web page by using AI.",
  folder: "get-universal-scraper",
  method: "GET",
  operationId: "getUniversal-Scraper",
  parameters: [
    {
      description:
    ...
    {
      description:
        "The parameter defines attributes to parse from a web page (e.g., `attributes=name,price,discount price,description`).",
      in: "query",
      location: "query",
      name: "attributes",
      required: false,
      ...
      content: [
        {
          example: {
            data: [
              {
                description:
                  "The ultimate smartphone from Apple, with advanced features, powerful performance, and a sleek design.",
                name: "iPhone",
                price: "$799",
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/universal-scraper?query=https://www.apple.com/iphone/&attributes=name,price,description&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/universal-scraper?query=https://www.apple.com/iphone/&attributes=name,price,description" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
