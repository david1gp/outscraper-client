...
export const bingMapsGetDefinition = {
  description: "Returns Bing Maps search results for one or more queries.",
  folder: "get-bing-maps",
  method: "GET",
  operationId: "getBing-Maps",
  parameters: [
    {
      description:
  ...
  summary: "Bing Maps Scraper",
  tags: ["Others", "Businesses & POI"],
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/bing-maps?query=restaurants%2C%20New%20York%2C%20NY&limit=3&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/bing-maps?query=restaurants%2C%20New%20York%2C%20NY&limit=3" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
