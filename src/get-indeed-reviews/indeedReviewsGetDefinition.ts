...
export const indeedReviewsGetDefinition = {
  description: "Returns reviews from Indeed companies.",
  folder: "get-indeed-reviews",
  method: "GET",
  operationId: "getIndeed-Reviews",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/indeed-reviews?query=TEKsystems&limit=3&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/indeed-reviews?query=TEKsystems&limit=3" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
