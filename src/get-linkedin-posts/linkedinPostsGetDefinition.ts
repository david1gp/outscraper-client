...
export const linkedinPostsGetDefinition = {
  description: "Returns posts from Linkedin companies.",
  folder: "get-linkedin-posts",
  method: "GET",
  operationId: "getLinkedin-Posts",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/linkedin-posts?query=outscraper&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/linkedin-posts?query=outscraper" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
