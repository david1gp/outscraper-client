...
export const g2ReviewsGetDefinition = {
  description: "Returns reviews from a list of products.",
  folder: "get-g2-reviews",
  method: "GET",
  operationId: "getG2-Reviews",
  parameters: [
    {
      description:
    ...
    },
    {
      ...
      schema: {
        default: "g2_default",
        enum: ["g2_default", "most_recent", "most_helpful", "highest_rated", "lowest_rated"],
        type: "string",
      },
    },
    {
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/g2-reviews?query=https://www.g2.com/products/outscraper&limit=3&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/g2-reviews?query=https://www.g2.com/products/outscraper&limit=3" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
