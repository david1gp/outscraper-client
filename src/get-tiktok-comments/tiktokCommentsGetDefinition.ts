...
export const tiktokCommentsGetDefinition = {
  description: "Returns comments from TikTok videos.",
  folder: "get-tiktok-comments",
  method: "GET",
  operationId: "getTiktok-Comments",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/tiktok-comments?query=https://www.tiktok.com/@k1ra_lait/video/7529087250404019458&limit_per_query=100&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/tiktok-comments?query=https://www.tiktok.com/@k1ra_lait/video/7529087250404019458&limit_per_query=100" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "Python",
      source:
