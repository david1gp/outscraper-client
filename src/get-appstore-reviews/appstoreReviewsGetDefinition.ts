...
export const appstoreReviewsGetDefinition = {
  description: "Returns reviews from AppStore apps.",
  folder: "get-appstore-reviews",
  method: "GET",
  operationId: "getAppstore-Reviews",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/appstore-reviews?query=https://apps.apple.com/us/app/telegram-messenger/id686449807&limit=3&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/appstore-reviews?query=https://apps.apple.com/us/app/telegram-messenger/id686449807&limit=3" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
