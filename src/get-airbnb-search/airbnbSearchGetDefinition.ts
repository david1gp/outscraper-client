...
export const airbnbSearchGetDefinition = {
  description: "Returns search results from Airbnb.",
  folder: "get-airbnb-search",
  method: "GET",
  operationId: "getAirbnb-Search",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/airbnb-search?query=https://www.airbnb.com/s/Italy/homes&limit=3&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/airbnb-search?query=https://www.airbnb.com/s/Italy/homes&limit=3" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
