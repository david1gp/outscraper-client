...
export const whataspCheckerGetDefinition = {
  description: "Checks whether a phone is connected to the service.",
  folder: "get-whatasp-checker",
  method: "GET",
  operationId: "getWhatasp-Checker",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/whatasp-checker?query=12812368208" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
