...
export const hotelsSearchGetDefinition = {
  description: "Returns search results from Hotels.com",
  folder: "get-hotels-search",
  method: "GET",
  operationId: "getHotels-Search",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/hotels-search?query=https%3A%2F%2Fwww.hotels.com%2FHotel-Search%3Fdestination%3DToronto%252C%2520Ontario%252C%2520Canada%26regionId%3D4089%26sort%3DRECOMMENDED&limit=3&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/hotels-search?query=https%3A%2F%2Fwww.hotels.com%2FHotel-Search%3Fdestination%3DToronto%252C%2520Ontario%252C%2520Canada%26regionId%3D4089%26sort%3DRECOMMENDED&limit=3" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
