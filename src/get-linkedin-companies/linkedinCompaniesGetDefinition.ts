...
export const linkedinCompaniesGetDefinition = {
  description: "Returns information from the list of Linkedin companies.",
  folder: "get-linkedin-companies",
  method: "GET",
  operationId: "getLinkedin-Companies",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/linkedin-companies?query=outscraper&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/linkedin-companies?query=outscraper" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
