...
export const googleSearchNewsGetDefinition = {
  description: "Returns search results from Google News based on a given search query (or many queries).",
  folder: "get-google-search-news",
  method: "GET",
  operationId: "getGoogle-Search-News",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/google-search-news?query=bitcoin&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/google-search-news?query=bitcoin" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
