...
export const disposableEmailCheckerGetDefinition = {
  description: "Checks origins of email addresses (disposable, free, or corporate)",
  folder: "get-disposable-email-checker",
  method: "GET",
  operationId: "getDisposable-Email-Checker",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/disposable-email-checker?query=support@outscraper.com" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
