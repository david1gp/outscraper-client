...
export const yahooSearchGetDefinition = {
  description: "Returns search results from Yahoo.",
  folder: "get-yahoo-search",
  method: "GET",
  operationId: "getYahoo-Search",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/yahoo-search?query=outscraper&limit=3&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/yahoo-search?query=python&limit=3" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
