...
export const googleMapsSearchGetDefinition = {
  description:
  ...
  folder: "get-google-maps-search",
  method: "GET",
  operationId: "getGoogle-Maps-Search",
  parameters: [
    {
      description:
    ...
    {
      description:
        "Skip first N places from a query search, where N should be a multiple of 20 (e.g. 0, 20, ... 500). Used for pagination.",
      in: "query",
      location: "query",
      name: "skipPlaces",
      required: false,
