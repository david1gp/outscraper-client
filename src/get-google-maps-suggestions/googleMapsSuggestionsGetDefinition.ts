...
export const googleMapsSuggestionsGetDefinition = {
  description: "Get automatic search suggestions for your queries on Google Maps.",
  folder: "get-google-maps-suggestions",
  method: "GET",
  operationId: "getGoogle-Maps-Suggestions",
  parameters: [
    {
      description:
        "The latitude and longitude coordinates specifying the location for search (e.g., `37.427074,-122.1439166`, `40.7449819,-74.0271321`).",
      in: "query",
      location: "query",
      name: "coordinates",
      required: true,
