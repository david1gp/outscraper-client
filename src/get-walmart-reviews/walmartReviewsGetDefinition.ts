...
export const walmartReviewsGetDefinition = {
  description: "Returns reviews from a list of products.",
  folder: "get-walmart-reviews",
  method: "GET",
  operationId: "getWalmart-Reviews",
  parameters: [
    {
      description:
    ...
    },
    {
      ...
      schema: {
        default: "relevancy",
        enum: ["relevancy", "helpful", "submission-desc", "submission-asc", "rating-desc", "rating-asc"],
        type: "string",
      },
    },
    {
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/walmart-reviews?query=https://www.walmart.com/ip/Blackstone-Original-4-Burner-36-Propane-Omnivore-Griddle-with-Hard-Cover/1347629739&limit=3&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/walmart-reviews?query=https://www.walmart.com/ip/Blackstone-Original-4-Burner-36-Propane-Omnivore-Griddle-with-Hard-Cover/1347629739&limit=3" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
