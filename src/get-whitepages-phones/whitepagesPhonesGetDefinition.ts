...
export const whitepagesPhonesGetDefinition = {
  description: "Returns insights about phone number owners (name, address, etc.).",
  folder: "get-whitepages-phones",
  method: "GET",
  operationId: "getWhitepages-Phones",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/whitepages-phones?query=12812368208" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
