...
export const googlePlacesByDomainGetDefinition = {
  description:
    "Allows finding places by domains.\n\nIn case no places were found by your criteria, your search request will consume the usage of one place.",
  folder: "get-google-places-by-domain",
  method: "GET",
  operationId: "getGoogle-Places-By-Domain",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/google-places-by-domain?query=dominopark.com&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/google-places-by-domain?query=dominopark.com" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
