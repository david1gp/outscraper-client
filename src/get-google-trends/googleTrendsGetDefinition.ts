...
export const googleTrendsGetDefinition = {
  description: "Allows scraping results from Google Trends.",
  folder: "get-google-trends",
  method: "GET",
  operationId: "getGoogle-Trends",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/google-trends?query=tesla&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
