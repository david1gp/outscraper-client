...
export const phonesOwnersGetDefinition = {
  description: "Returns insights about phone number owners (name, address, etc.).",
  folder: "get-phones-owners",
  method: "GET",
  operationId: "getPhones-Owners",
  parameters: [
    {
      description:
  ...
  summary: "Phone Owners",
  tags: ["Phone Related", "Others"],
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/phones-owners?query=12812368208" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
