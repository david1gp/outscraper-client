...
export const twitterProfilesGetDefinition = {
  description: "Returns information from the list of Twitter profiles.",
  folder: "get-twitter-profiles",
  method: "GET",
  operationId: "getTwitter-Profiles",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/twitter-profiles?query=outscraper&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/twitter-profiles?query=outscraper" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
