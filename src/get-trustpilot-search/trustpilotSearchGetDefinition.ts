...
export const trustpilotSearchGetDefinition = {
  description: "Returns search results from Trustpilot.",
  folder: "get-trustpilot-search",
  method: "GET",
  operationId: "getTrustpilot-Search",
  parameters: [
    {
      description:
