...
export const emailValidatorGetDefinition = {
  description: "Validates email addresses and checks whether they are deliverable.",
  folder: "get-email-validator",
  method: "GET",
  operationId: "getEmail-Validator",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/validators/email?query=support@outscraper.com&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/validators/email?query=support@outscraper.com" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
