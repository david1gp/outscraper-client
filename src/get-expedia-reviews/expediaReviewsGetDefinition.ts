...
export const expediaReviewsGetDefinition = {
  description: "Returns reviews from expedia.com places.",
  folder: "get-expedia-reviews",
  method: "GET",
  operationId: "getExpedia-Reviews",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/expedia-reviews?query=https://www.expedia.com/Las-Vegas-Hotels-The-Orleans-Hotel-Casino.h41313.Hotel-Information&limit=3&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/expedia-reviews?query=https://www.expedia.com/Las-Vegas-Hotels-The-Orleans-Hotel-Casino.h41313.Hotel-Information&limit=3" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
