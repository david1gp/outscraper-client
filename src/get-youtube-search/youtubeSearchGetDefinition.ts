...
export const youtubeSearchGetDefinition = {
  description: "Returns search results from YouTube.",
  folder: "get-youtube-search",
  method: "GET",
  operationId: "getYoutube-Search",
  parameters: [
    {
      description:
      ...
      content: [
        {
          example: {
            data: [
              {
                estimated_results: "537091926",
                organic_results: [
                  {
                    channel_thumbnail:
                      "https://yt3.ggpht.com/EVQSeCZYlBrba-D6-RHiWOr3nPbGneftZCwWhz0lQyYiug7ff9-ZRjfYOhzgBs0Fbxs5D9hJwxY=s68-c-k-c0x00ffffff-no-rj",
                    channel_title: "Naughty Animals",
                    channel_url: "https://www.youtube.com/@naughtyanimalstv",
                    video_id: "N8siuNjyV7A",
                    video_length: "1:01:24",
                    video_published: "1 month ago",
                    ...
                    video_thumbnail:
                      "https://i.ytimg.com/vi/N8siuNjyV7A/hq720.jpg?sqp=-oaymwEcCNAFEJQDSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&rs=AOn4CLDjrkgH8B8y9Lw4ygPNe8OC-iNiag",
                    video_title: "1 Hour Of Funniest Animals 😅 New Funny Cats and Dogs Videos 😸🐶 Part 14",
                    video_url: "https://www.youtube.com/watch?v=N8siuNjyV7A",
                    video_views: "21,564,254",
                  },
                ],
                query: "cats",
              },
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/youtube-search?query=cats&limit=1&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/youtube-search?query=cats&limit=1" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
