...
export const expediaSearchGetDefinition = {
  description: "Returns search results from expedia.com",
  folder: "get-expedia-search",
  method: "GET",
  operationId: "getExpedia-Search",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/expedia-search?query=https://www.expedia.com/Hotel-Search?destination=Ankara...&limit=3&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/expedia-search?query=https://www.expedia.com/Hotel-Search?destination=Ankara...&limit=3" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
