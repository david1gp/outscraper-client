...
export const googleSearchCareersGetDefinition = {
  description: "Allows scraping search results from Google Careers.",
  folder: "get-google-search-careers",
  method: "GET",
  operationId: "getGoogle-Search-Careers",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/google-search-careers?query=developer&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/google-search-careers?query=developer" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
