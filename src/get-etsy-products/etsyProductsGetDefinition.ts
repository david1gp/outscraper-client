...
export const etsyProductsGetDefinition = {
  description: "Returns product information from Etsy.",
  folder: "get-etsy-products",
  method: "GET",
  operationId: "getEtsy-Products",
  parameters: [
    {
      description:
              ...
              [
                {
                  ...
                  images: ["https://i.etsystatic.com/12345678/r/il/abcdef/1234567890/il_fullxfull.1234567890_abcd.jpg"],
                  max_price: "89.00",
                  min_price: "89.00",
  ...
  summary: "Etsy Products",
  tags: ["Etsy", "Products & Listings"],
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/etsy-products?query=https://www.etsy.com/listing/1234567890&limit=3&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/etsy-products?query=https://www.etsy.com/listing/1234567890&limit=3" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
