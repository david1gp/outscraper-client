...
export const emailsFinderGetDefinition = {
  description: "Finds professional emails by names.",
  folder: "get-emails-finder",
  method: "GET",
  operationId: "getEmails-Finder",
  parameters: [
    {
      description:
