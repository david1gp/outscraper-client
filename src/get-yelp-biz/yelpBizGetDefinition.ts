...
export const yelpBizGetDefinition = {
  description: "Returns business information from Yelp.",
  folder: "get-yelp-biz",
  method: "GET",
  operationId: "getYelp-Biz",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/yelp-biz?query=eggcellent-waffles-san-francisco&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/yelp-biz?query=eggcellent-waffles-san-francisco" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
