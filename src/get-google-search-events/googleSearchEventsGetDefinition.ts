...
export const googleSearchEventsGetDefinition = {
  description: "Returns search results from Google Events based on a given search query (or many queries).",
  folder: "get-google-search-events",
  method: "GET",
  operationId: "getGoogle-Search-Events",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/google-search-events?query=bitcoin&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/google-search-events?query=bitcoin" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
