...
export const airbnbReviewsGetDefinition = {
  description: "Returns reviews from Airbnb accommodations.",
  folder: "get-airbnb-reviews",
  method: "GET",
  operationId: "getAirbnb-Reviews",
  parameters: [
    {
      description:
    ...
    },
    {
      ...
      schema: {
        default: "MOST_RECENT",
        enum: ["MOST_RECENT", "RATING_DESC", "RATING_ASC"],
        type: "string",
      },
    },
    {
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/airbnb-reviews?query=https://www.airbnb.com/rooms/927539322986647456&limit=3&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/airbnb-reviews?query=https://www.airbnb.com/rooms/927539322986647456&limit=3" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
