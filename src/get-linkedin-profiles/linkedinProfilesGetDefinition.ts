...
export const linkedinProfilesGetDefinition = {
  description: "Returns information from the list of Linkedin profiles.",
  folder: "get-linkedin-profiles",
  method: "GET",
  operationId: "getLinkedin-Profiles",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/linkedin-profiles?query=realvlad&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/linkedin-profiles?query=realvlad" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
