...
export const glassdoorReviewsGetDefinition = {
  description: "Returns reviews from Glassdoor companies.",
  folder: "get-glassdoor-reviews",
  method: "GET",
  operationId: "getGlassdoor-Reviews",
  parameters: [
    {
      description:
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/glassdoor-reviews?query=https%3A%2F%2Fwww.glassdoor.com%2FReviews%2FAmazon-Reviews-E6036.htm&limit=3&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/glassdoor-reviews?query=https%3A%2F%2Fwww.glassdoor.com%2FReviews%2FAmazon-Reviews-E6036.htm&limit=3" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
