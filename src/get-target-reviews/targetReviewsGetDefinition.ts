...
export const targetReviewsGetDefinition = {
  description: "Returns reviews from a list of products.",
  folder: "get-target-reviews",
  method: "GET",
  operationId: "getTarget-Reviews",
  parameters: [
    {
      description:
    ...
    },
    {
      ...
      schema: {
        default: "most_recent",
        enum: ["most_recent", "highest_rating", "lowest_rating", "helpfulness_desc"],
        type: "string",
      },
    },
    {
  ...
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/target-reviews?query=https://www.target.com/p/apple-iphone-15-pro-max/-/A-89957794&limit=3&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/target-reviews?query=https://www.target.com/p/apple-iphone-15-pro-max/-/A-89957794&limit=3" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
