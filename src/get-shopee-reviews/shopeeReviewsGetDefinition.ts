...
export const shopeeReviewsGetDefinition = {
  description: "Returns reviews from a list of products.",
  folder: "get-shopee-reviews",
  method: "GET",
  operationId: "getShopee-Reviews",
  parameters: [
    {
      description:
    ...
    {
      description:
        "The parameter specifies which reviews to return: `0` for all reviews, `1` for reviews with comments, and `3` for reviews with media.",
      in: "query",
      location: "query",
      name: "sort",
      required: false,
  ...
  summary: "Shopee Reviews",
  tags: ["Others", "Reviews & Comments"],
  "x-codeSamples": [
    {
      lang: "cURL",
      source:
        'curl -X GET "https://api.outscraper.cloud/shopee-reviews?query=https://shopee.ph/Apple-iPhone-14-Pro-(6.1-inch)-i.350609763.20351784876&limit=3&sort=0&async=false" -H  "X-API-KEY: YOUR-API-KEY"',
    },
    {
      lang: "cURL (async)",
      source:
        'curl -X GET "https://api.outscraper.cloud/shopee-reviews?query=https://shopee.ph/Apple-iPhone-14-Pro-(6.1-inch)-i.350609763.20351784876&limit=3&sort=0" -H  "X-API-KEY: YOUR-API-KEY"',
    },
  ],
} as const
